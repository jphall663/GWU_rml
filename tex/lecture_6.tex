	...
	%-------------------------------------------------------------------------------
		...
		\subsection*{}
			...
			\begin{frame}
				...
				\begin{columns}
					...
					\begin{itemize}
						...
						\item \href{https://docs.h2o.ai/driverless-ai/1-10-lts/docs/userguide/transformations.html}{H2o.ai feature transformation list}
			...
			\begin{frame}
				...
				\begin{columns}
					...
					\begin{itemize}
						...
						\item References: \citefield{pate}{title}; \citefield{zhang2018mitigating}{title}; \citefield{pearl2011bayesian}{title}; \citefield{wf_xnn}{title} (XNN); \citefield{nori2021accuracy}{title}; \citefield{title}{agarwal2021neural}
					\end{itemize}
					\normalsize
			...
			\begin{frame}		
				...
				\begin{columns}
					...
					\begin{itemize}
						...
						\item OSS: \href{https://github.com/SolasAI/solas-ai-disparity}{solas-ai-disparity}, \href{https://github.com/dssg/aequitas}{aequitas}, IBM \href{https://github.com/IBM/AIF360}{AIF360}, \href{https://github.com/LASER-UMASS/Themis}{themis}
			...
			\begin{frame}
				...
				\vspace{-10pt}
				\scriptsize{Your model will be wrong. Estimate how much wrong decisions or bad usage will cost. Stake-holders need to understand and be prepared for the human and financial costs of these poor outcomes.}	
			...
			\begin{frame}
				...
				\begin{columns}
					...
					\vspace{-5pt}
					\begin{itemize}
						\item Reference: \citefield{model_cards}{title}, \citefield{pushkarna2022data}{title}
			...
			\begin{frame}	
				...
				%\vspace{-10pt}
				\footnotesize{When a model becomes absolutely or relatively inaccurate, unfair, or insecure it must be taken out of service, but saved in an executable and reproducible manner. Alternatively, how will major services changes be communicated?}
