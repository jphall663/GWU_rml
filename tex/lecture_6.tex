			...
			\begin{frame}
				...
				\begin{columns}
					...
					\begin{itemize}
						...
						\item References: \citefield{pate}{title}; \citefield{zhang2018mitigating}{title}; \citefield{pearl2011bayesian}{title}; \citefield{wf_xnn}{title} (XNN); \citefield{nori2021accuracy}{title}; \citefield{agarwal2021neural}{title}
					\end{itemize}
					\normalsize
