...
%-------------------------------------------------------------------------------
	...
	\begin{frame}
		...
		\frametitle{Use Explainable ML to \textbf{Enhance Understanding}}
	...
	\begin{frame}[label={no_trust}]
		...
		\frametitle{Understanding \textbf{Without} Trust}
	...
	\begin{frame}
		...
		\frametitle{Trust \textbf{Without} Understanding}
		\Large
...
%-------------------------------------------------------------------------------
	...
	\begin{frame}
		...
		\frametitle{Explainable ML Can be Used for \textbf{Nefarious Purposes}}	
		\Large
...
\footnotesize{Many ML hacks use, or are exacerbated by, explainable ML techniques.}\footnote{\tiny{See \url{https://github.com/jphall663/secure_ML_ideas} for full size image and more information.}}
	...
	\begin{frame}
		...
		\frametitle{\large{\textbf{Case 1}: White-hat Attacks Can Crack Potentially Harmful Black-boxes}}
		\large
	...
	\begin{frame}[label={not_frontline}]
		...
		\frametitle{\textbf{Case 2}: Explanation \textbf{\textit{is Not}} a Front Line Fairness Tool}
		\large
...
%-------------------------------------------------------------------------------
	...
	\begin{frame}[t]
		...
		\frametitle{Augment \textbf{Surrogate Models} with \textbf{Direct Explanations}}	
	...
	\begin{frame}[t, label={lime}]
		...
		\frametitle{\textbf{Example}: Augment LIME with Direct Explanations}
...
%-------------------------------------------------------------------------------
	...
	\begin{frame}
		...
		\frametitle{Use Highly Transparent Mechanisms for \textbf{High Stakes Applications}}
		\vspace{2pt}
...
% XNN
		...
		\frametitle{\normalsize{\textbf{Case 1}: Use \textbf{Interpretable Models} for High Stakes Applications (\citet{please_stop})}}
	...
	\begin{frame}[label={dt}]
		...
		\frametitle{\textbf{Case 2}: Explanations and Interpretable Models are Not Mutually Exclusive}
	...
	\begin{frame}[t]
		...
		\frametitle{\large{\textbf{Case 3}: Explanation and Fairness Techniques are Not Mutually Exclusive}}
