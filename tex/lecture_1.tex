...
%--------------------------------------------------------------------------
		...
		\begin{frame}
			...
			\begin{itemize}
				\item Generalized additive model (GAM) (\cite{esl})
				\item GA2M/Explainable boosting machine (EBM) (\cite{ga2m})
				\item Explainable Neural Network (XNN) (\cite{wf_xnn})
				\item Rudin group: 
				\begin{itemize}
					\item \textit{This looks like that} deep learning (\cite{this_looks_like_that})
