...
\noindent\textbf{Example}: \url{https://github.com/jphall663/GWU_DNSC_6301_project}. (This example is not complete, but should get you started on the right path.)

\section{Instructions and Rubric.}

This is a pure technical writing assignment. Very little introduction, narrative, or conclusion text is necessary. You may make copious use of bullet points, charts, and tables. (But remember that all charts and tables should have numbers and descriptions!)\\
...
\noindent \textbf{Your deliverable is due Sunday, May 4\textsuperscript{th}, at 11:59 PM ET.}\\
